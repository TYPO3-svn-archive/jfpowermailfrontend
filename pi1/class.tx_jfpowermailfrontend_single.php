...
class tx_jfpowermailfrontend_single extends tslib_pibase
{
	...
	*/
	...
	public function hook_pmfe_single(&$rowArray)
	{
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jfpowermailfrontend/pi1/class.tx_jfpowermailfrontend_single.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jfpowermailfrontend/pi1/class.tx_jfpowermailfrontend_single.php']);
}

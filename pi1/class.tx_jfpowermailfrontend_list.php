...
require_once(t3lib_extMgm::extPath('jfpowermailfrontend') . 'lib/class.tx_jfpowermailfrontend_markers.php'); // load marker class
require_once(t3lib_extMgm::extPath('jfpowermailfrontend') . 'lib/class.tx_jfpowermailfrontend_dynamicmarkers.php'); // file for dynamicmarker functions
require_once(t3lib_extMgm::extPath('jfpowermailfrontend') . 'lib/class.tx_jfpowermailfrontend_div.php'); // load div class
require_once(t3lib_extMgm::extPath('jfpowermailfrontend') . 'lib/class.tx_jfpowermailfrontend_pagebrowser.php'); // load pagebrowser class

class tx_jfpowermailfrontend_list extends tslib_pibase
{
	public $extKey = 'jfpowermailfrontend';
	public $prefixId = 'tx_jfpowermailfrontend_pi1';
	public $scriptRelPath = 'pi1/class.tx_jfpowermailfrontend_list.php';
	public $mode = 'list';
	...
	*/
	public function main($conf, $piVars, $cObj)
	{
		...
		$this->markers = t3lib_div::makeInstance('tx_jfpowermailfrontend_markers'); // Create new instance for markers class
		$this->dynamicMarkers = t3lib_div::makeInstance('tx_jfpowermailfrontend_dynamicmarkers'); // New object: TYPO3 dynamicmarker function
		$this->div = t3lib_div::makeInstance('tx_jfpowermailfrontend_div'); // Create new instance for div class
		$this->pagebrowser = t3lib_div::makeInstance('tx_jfpowermailfrontend_pagebrowser'); // Create new instance for pagebrowser class
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jfpowermailfrontend/pi1/class.tx_jfpowermailfrontend_list.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jfpowermailfrontend/pi1/class.tx_jfpowermailfrontend_list.php']);
}

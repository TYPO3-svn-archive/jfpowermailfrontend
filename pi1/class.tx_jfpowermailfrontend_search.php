...
require_once(t3lib_extMgm::extPath('jfpowermailfrontend') . 'lib/class.tx_jfpowermailfrontend_filter_abc.php'); // load abc class
require_once(t3lib_extMgm::extPath('jfpowermailfrontend') . 'lib/class.tx_jfpowermailfrontend_filter_search.php'); // load searchfilter class

class tx_jfpowermailfrontend_search extends tslib_pibase
{
	public $extKey = 'jfpowermailfrontend';
	public $prefixId = 'tx_jfpowermailfrontend_pi1';
	public $scriptRelPath = 'pi1/class.tx_jfpowermailfrontend_single.php';
	public $mode = 'search';
	...
	public function main($conf, $piVars, $cObj)
	{
		...
		$this->abc = t3lib_div::makeInstance('tx_jfpowermailfrontend_filter_abc'); // New object: TYPO3 abc function
		$this->search = t3lib_div::makeInstance('tx_jfpowermailfrontend_filter_search'); // New object: TYPO3 searchfilter function
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jfpowermailfrontend/pi1/class.tx_jfpowermailfrontend_search.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jfpowermailfrontend/pi1/class.tx_jfpowermailfrontend_search.php']);
}

...
class tx_jfpowermailfrontend_filter_search extends tslib_pibase
{
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jfpowermailfrontend/lib/class.tx_jfpowermailfrontend_filter_search.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jfpowermailfrontend/lib/class.tx_jfpowermailfrontend_filter_search.php']);
}
?>
...
class tx_jfpowermailfrontend_markers extends tslib_pibase
{
	var $extKey = 'jfpowermailfrontend';
	var $prefixId = 'tx_jfpowermailfrontend_pi1';
	var $scriptRelPath = 'pi1/class.tx_jfpowermailfrontend_list.php';
	var $mode = 'default';
	...
	*/
	...
	{
		// config
		$local_cObj = $GLOABALS['TSFE']->cObj; // cObject
		$this->conf = $conf;
		$this->piVars = $piVars;
		$this->cObj = $cObj;
		$this->pi_loadLL();
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jfpowermailfrontend/lib/class.tx_jfpowermailfrontend_markers.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jfpowermailfrontend/lib/class.tx_jfpowermailfrontend_markers.php']);
}
?>

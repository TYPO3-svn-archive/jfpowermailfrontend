...
class tx_jfpowermailfrontend_div extends tslib_pibase
{
	...
	*/
	public function sortArray($array, $conf, $mode, $piVars)
	{
		...
		// let's go
		if ($this->conf[$this->mode . '.']['orderby']) usort($this->varray, array('tx_jfpowermailfrontend_div', 'cmp')); // sorting
		return $this->varray;
	}
	...
	*/
	...
	/** 
	 * Delete entry if &tx_jfpowermailfrontend_pi1[delete]= 
	 * 
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jfpowermailfrontend/lib/class.tx_jfpowermailfrontend_div.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jfpowermailfrontend/lib/class.tx_jfpowermailfrontend_div.php']);
}
?>
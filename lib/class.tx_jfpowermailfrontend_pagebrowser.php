...
class tx_jfpowermailfrontend_pagebrowser extends tslib_pibase
{
	var $extKey = 'jfpowermailfrontend';
	var $prefixId = 'tx_jfpowermailfrontend_pi1';
	var $scriptRelPath = 'pi1/class.tx_jfpowermailfrontend_pi1.php';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jfpowermailfrontend/lib/class.tx_jfpowermailfrontend_pagebrowser.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jfpowermailfrontend/lib/class.tx_jfpowermailfrontend_pagebrowser.php']);
}

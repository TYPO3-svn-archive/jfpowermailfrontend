...
class tx_jfpowermailfrontend_filter_abc extends tslib_pibase {

	var $extKey = 'jfpowermailfrontend'; // Extension key
	var $prefixId = 'tx_jfpowermailfrontend_pi1';		// Same as class name
	var $scriptRelPath = 'pi1/class.tx_jfpowermailfrontend_pi1.php';	// Path to this script relative to the extension dir.
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jfpowermailfrontend/lib/class.tx_jfpowermailfrontend_filter_abc.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jfpowermailfrontend/lib/class.tx_jfpowermailfrontend_filter_abc.php']);
}
